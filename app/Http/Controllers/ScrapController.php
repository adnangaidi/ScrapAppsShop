...
class ScrapController extends Controller
{
    ...
    {
        try {
            $res = shell_exec('C:/PYTHON/python.exe "d:/stage/Nouveau dossier/appscrap/app/Script_python/info_app/script_info_app.py" "' . $url . '"');
    ...
    {
        try {
            $res = shell_exec('C:/PYTHON/python.exe "d:/stage/Nouveau dossier/appscrap/app/Script_python/info_app/script_image.py" "' . $url . '"');
        $result = json_decode($res, true);
        Log::info($result);
    ...
    {
         try {
            $res = shell_exec('C:/PYTHON/python.exe "d:/stage/Nouveau dossier/appscrap/app/Script_python/info_app/script_desc_app.py" "' . $url . '"');
        $result = json_decode($res, true);
    ...
    {
        try {
            $res = shell_exec('C:/PYTHON/python.exe "d:/stage/Nouveau dossier/appscrap/app/Script_python/info_app/script_tarif_app.py" "' . $url . '"');
        $result = json_decode($res, true);
        if ($result) {
            for ($i = 0; $i < count($result); $i++) {
                $tarif_app = new Tarif();
    ...
    {
        try {
            $res = shell_exec('C:/PYTHON/python.exe "d:/stage/Nouveau dossier/appscrap/app/Script_python/info_app/script_reviews.py" "' . $url . '"');
        $result = json_decode($res, true);
        // Log::info("result",$result);
        if ($result) {
            for ($i = 0; $i < count($result); $i++) {
